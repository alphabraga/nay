        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <p class="text-muted text-center">[Colocar Aqui o Nivel no Sistema]</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Vendas</b> <a class="pull-right">[colocar aqui o numero de vendas]</a>
                </li>
                <li class="list-group-item">
                  <b>Encomendas</b> <a class="pull-right">[numero de encomendas]</a>
                </li>
                <li class="list-group-item">
                  <b>Pedidos</b> <a class="pull-right">[numero de pedidos]</a>
                </li>
              </ul>
            </div>
            <!-- /.box-body -->
