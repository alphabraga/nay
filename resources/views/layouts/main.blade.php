      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            <a id="cart-icon" href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-shopping-cart"></i>
              <!-- <span class="label label-warning">10</span> -->
            </a>
            <ul class="dropdown-menu">
              <li class="header">Voce tem <span id="cart-total-itens"></span> itens no carrinho</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-money text-aqua"></i> Total de <span id="total-carrinho"></span>
                    </a>
                  </li>
                </ul>
              </li>
              <li class="footer"><a href="{{URL::to('/carrinho')}}">Ver carrinho</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{Url::to($usuario->getPhoto())}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{$usuario->name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{Url::to($usuario->getPhoto())}}" class="img-circle" alt="User Image">
