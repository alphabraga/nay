...
<section class="content-header">
  <h1><i class="fa fa-truck fa-fw"></i>Transportadora <small>Atualização</small></h1>
  <ol class="breadcrumb">
    <li><a href="{{action('ShippingCompanyController@index')}}"><i class="fa fa-truck fa-fw"></i> Fornecedores</a></li>
